...
// include: /var/folders/2f/mnjk1ps54knfyc8vl1qtr5tr0000gr/T/tmpt9utikna.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'OfficeOnFire.data';
      var REMOTE_PACKAGE_BASE = 'OfficeOnFire.data';
...
Module['FS_createPath']("/", "floors", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_OfficeOnFire.data');

      }
      Module['addRunDependency']('datafile_OfficeOnFire.data');
    ...
    loadPackage({"files": [{"filename": "/floors/README.md", "start": 0, "end": 495}, {"filename": "/floors/floor0.txt", "start": 495, "end": 1162}, {"filename": "/floors/floor1.txt", "start": 1162, "end": 1429}, {"filename": "/floors/floor2.txt", "start": 1429, "end": 1720}, {"filename": "/floors/floor3.txt", "start": 1720, "end": 2280}, {"filename": "/floors/floor4.txt", "start": 2280, "end": 4193}, {"filename": "/floors/floor5.txt", "start": 4193, "end": 4911}, {"filename": "/floors/floor6.txt", "start": 4911, "end": 8329}, {"filename": "/floors/floor7.txt", "start": 8329, "end": 9049}], "remote_package_size": 9049});

  })();

// end include: /var/folders/2f/mnjk1ps54knfyc8vl1qtr5tr0000gr/T/tmpt9utikna.js
// include: /var/folders/2f/mnjk1ps54knfyc8vl1qtr5tr0000gr/T/tmpbf5ab1sf.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/2f/mnjk1ps54knfyc8vl1qtr5tr0000gr/T/tmpbf5ab1sf.js
// include: /var/folders/2f/mnjk1ps54knfyc8vl1qtr5tr0000gr/T/tmp92zbhmco.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/2f/mnjk1ps54knfyc8vl1qtr5tr0000gr/T/tmp92zbhmco.js
...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('OfficeOnFire.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('OfficeOnFire.wasm', import.meta.url).href;
}
